...
import in.sisoft.all_in_one.adapter.PromoListRecyclerViewAdapter;
...
public class DbServAllPromoListAyncTask extends AsyncTask<String, Void, Void> {
...
//    DbHelper dbHelper ;
    ...
    public DbServAllPromoListAyncTask(Context ctx, RecyclerView v1, Activity act)
    {
        my_ctx = ctx ;
        rv = v1 ;
        a1 = act ;
    ...
    protected Void doInBackground(String... urls) {
        ...
        try
        {
            ...
            URL url = new URL(AppConstants.allPromoList);
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView, ArrayList<Promotions> al_be1) {
        ...
        if (al_be1.size() == 0) {
            ...
            PromoListRecyclerViewAdapter rva = new PromoListRecyclerViewAdapter(al_be1, a1,1);
